        ...
        <g transform={animated ? "translate(50,50) scale(0.82) translate(-50,-50)" : undefined}>
          <g className={animated ? "edward-float" : undefined}>
            ...
            <g className={animated ? "edward-eye-glow" : undefined}>
              <circle cx="40" cy="52" r="4" fill="#52b788" className={animated ? "edward-blink" : undefined} />
              <circle cx="60" cy="52" r="4" fill="#52b788" className={animated ? "edward-blink" : undefined} />
            </g>
            ...
            <rect x="42" y="62" width="16" height="2" rx="1" fill="#52b788" fillOpacity="0.8" className={animated ? "edward-mouth" : undefined} />
          </g>
        </g>
      </svg>
    </div>
